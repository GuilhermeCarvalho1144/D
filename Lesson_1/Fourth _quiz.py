...
print 'The file project_submissions.csv had {} lines before cleaning. After cleaning the file have {} lines'.format(len(proj_sub), unique(proj_sub))
print 'The file enrollments.csv had {} lines before cleaning. After cleaning the file have {} lines'.format(len(errol), unique(errol))
print 'The file daily_engagement.csv had {} lines before cleaning. After cleaning the file have {} lines'.format(len(daily_enga), unique(daily_enga))