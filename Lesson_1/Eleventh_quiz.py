#==============================================================================
# THIS CODE IMPLEMENTS THE ELEVENTH QUIZ FROM INDTRODUCTION TO DATA ANALYSIS COURSE
...
#O RGANAZING THE ENGAGEMENT RECORDS 
...
# CALCULATING THE NUMBER OF LESSONS
...
# CALCULATING THE NUMBER OS ACCOUNTS MARKED
days_visited_by_account = sum_gruped_items(engagement_by_account, 'has_visited')

# SUMM THE TOTAL NUMBER OF ACCOUNTS MARKED
total_days_visited = days_visited_by_account.values()

# PRINTING THE RESULTS
print 'TOTAL DAYS VISITED IN AVERAGE IS {}'.format(np.mean(total_days_visited))
print 'THE STANDAR DEVIATION IS {}'.format(np.std(total_days_visited))
print 'THE MAX OF DAYS VISITED IS {}'.format(np.max(total_days_visited))
print 'THE MIN OF DAYS VSITED IS {}'.format(np.min(total_days_visited))
